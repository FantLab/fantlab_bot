...
top100questions = [
	...
	[
		...
		[
			...
			['Можно. Тогда лучше что-то весёлое про киберпространство', 'Нил Стивенсон «Криптономикон»\nhttps://fantlab.ru/work9769']
		]
	],
	[
		'Вас расстроит, если в книге не будет *шрамированного подростка в магической школе*?',
		[
			['Да. Без Поттера и книга не книга, и фильм не фильм!', 'Патрик Ротфусс «Имя ветра»\nhttps://fantlab.ru/work188170'],
