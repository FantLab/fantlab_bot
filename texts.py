...
helpText = '/help - выводит этот текст\n/book - переходит к рекомендации книг\n/top100 - Интерактивный путеводитель по Top-100 фантастических книг [Перевод интерактивной версии от сайта sfsignal.com, основанный на 100 Лучших НФ и Фэнтези книг (NPR Top 100)]\n/authors - поиск информации об авторе'
botErrorText = 'Ну вот, кажется, я поломался. Пожалуйста, выполните команду /start и напишите моему разработчику (@qiray). Он поможет.'
pleaseWaitText = "Пожалуйста, подождите, ищу книгу специально для вас..."
showRecomendsText = "Перейти к рекомендациям"
showtop100Text = "Перейти к путеводителю Top-100"
show_authors = "Найти информацию об авторе"
showtop100AgainText = "Подобрать заново"
startText = 'Я предназначен для работы с базой Фантлаба (https://fantlab.ru/).\nДля получения книжной рекомендации введите команду /book или нажмите на кнопку "' + showRecomendsText + '"\nДля выбора книга из списка Топ-100 введите команду /top100 или нажмите на кнопку "' + showtop100Text + '"\nДля поиска информации об авторе введите команду /authors или нажмите на кнопку "' + show_authors + '"'
...
AUTHORSREQUESTTEXT = 'Просто напишите имя или фамилию автора (а лучше и то и другое), чтобы получить информацию о нем:'
AUTHORS_OTHER = 'Не они. А еще есть?'
NO_AUTHORS = 'Мне жаль, но я не нашел ничего по вашему запросу.'
TRY_AGAIN_AUTHORS = 'Попробуете еще раз?'
AUTHORS_ANOTHER_REQUEST = 'Хочу найти другого'
NO_THANKS = 'Нет, спасибо.'
MAIN_MENU = 'В главное меню.'
SAME_ANSWER_ERROR = 'Устал я одно и то же повторять. :-('

AUTHORS_VARIANTS = [
	'Кажется, нашел:',
	'Результат специально для вас:',
	'Сообщаю ответ по вашему запросу:',
	'Ура! Нашел!',
	'Вот что мне удалось раздобыть:'
]

WRONG_COMMAND = 'К сожалению, я не смог понять ваш запрос :-(\nПопробуйте команду /help или /start'
...
requestStepsArray = [
	...
	[
		["Раньше было лучше, XIX век максимум.", "&byyear=on&yearfrom=&yearto=1900", 5],
		["Первая половина XX века", "&byyear=on&yearfrom=1900&yearto=1950", 5],
		["Вторая половина XX века", "&byyear=on&yearfrom=1950&yearto=2000", 5],
		["Только самое свежее.", "&byyear=on&yearfrom=2000&yearto=", 5],
		['Не важно', "NONE", 5]
	]
]

requestNamesArray = ["Что читаем?", "Где разворачивается действие?", "Когда происходят события?", "И кто же авторы?", "А размер имеет значение?", "Свежее или постарше?"]
